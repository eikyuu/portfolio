    ...
    <section data-aos="fade-up" className="about" id="about">
      <div className="about_div">
        ...
        <p className="about_p mt-5  mb-5">
          ...
          projets. « La création d'un site web ou d'une application est un art.
          On peint le code comme un tableau, une œuvre prend vie lentement sous
          nos doigts. »
        </p>
      </div>
    </section>
